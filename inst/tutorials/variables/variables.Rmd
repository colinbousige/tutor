...
I defined two random variables `x` and `y`. Are the two variables equal?
...
Find the index of all the `"e"` characters in the string, using base functions and `stringr` ones:
